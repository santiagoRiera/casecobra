...
export const Icon = {
    //underline es una propiedad de Icon y las props se pasan automaticamente al svg
    underline: (props: LucideProps) => (
        //viewBox define el area visible del svg, det, coordenadas min y max
        <svg {...props} viewBox='0 0 687 155'>
            {/*g agrupa elementos graficos permitiendo aplicar propiedades comunes a todos los hijos */}
            <g
                stroke='currentColor'
                strokeWidth='7'
                fill='none'
