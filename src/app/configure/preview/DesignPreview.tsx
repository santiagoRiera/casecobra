...
const DesignPreview = ({configuration}: {configuration: Configuration}) => {
    ...
    const {mutate: createPaymentSession} = useMutation({
        ...
        //Mandamos al usuario a la url de stripe
        onSuccess: ({url}) => {
            if (url){
                router.push(url)
            }
    ...
    const handleCheckout = () => {
        if(user){
            ...
            //need to log in. We save the configuration id in local storage 
  ...
  return (
    <>
        ...
        >
            <Confetti active={showConfetti} config={{elementCount: 300, spread: 150}}/>
        </div>
                    ...
                    <div className='grid grid-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10'>
                        <div>
                            ...
                            <ol className='mt-3 text-zinc-700 list-disc list-inside'>
                                <li>Wireless chargind compatible</li>
                        ...
                        <div className='bg-gray-50 p-6 sm:rounded-lg sm:p-8'>
                            <div className='flow-root text-sm'>
                                ...
                                {finish == "textured" ? (
                                    ...
                                    <p className='font-medium text-gray-900'>
                                        {/*podriamos usar (FINISHES.options[1].pr /100) pero mejor si buscamos el precio directo */}
