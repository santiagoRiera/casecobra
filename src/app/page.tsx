...
export default function Home() {
  return (
    <div className="bg-slate-50">
      <section>
        <MaxWidthWrapper className="pb-24 pt-10 sm:pb-23 lg:grid lg:grid-cols-3 lg:gap-x-0
        lg:pt-24 lg:pb-52 xl:pt-32 xl:gap-x-8">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            ...
            items-center lg:items-start">
              ...
              text-balance md:text-wrap">
                Capture your favorite memories with yout own, <span className="font-semibold">
              ...
              sm:items-start">
                <div className="space-y-2">
                  ...
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="h-5 w-5 shrink-0 text-green-600"/>
                    <span>5 years print guarantee</span>
                  </li>
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="h-5 w-5 shrink-0 text-green-600"/>
          ...
          sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              <img src="/your-image.png" className="absolute w-40 lg:w-52 left-56 -top-20
              select-none hidden sm:block lg:hidden xl:block" alt="your image arrow"/>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            ...
            !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
              ...
              <span className="relative px-2">
                customers <Icon.underline className="hidden sm:block pointer-events-none
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  the case for two and a half months now and <span className="p-0.5 bg-slate-800
                  text-white">the image is super clear</span>, on the case I had before, the
                  image started fading into yellow-ish color after a couple weeks. Love it!"
                </p>
              </div>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  </span>, on the case I had before, the
                  . I dig it!"
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                ...
                />
                <div className="flex flex-col">
                  <p className="font-semibold">Jannik</p>
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="h-4 w-4 stroke-[3px] text-green-600"/>
                    <p className="text-sm">Verified purchase</p>
                  </div>
        ...
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="order-1 mt-2 tracking-tight text-center text-balance
              !leading-normal font-bold text-5xl md:text-6xl text-gray-900">
                Upload your photo and get {' '}
                <span className="relative px-1 bg-green-600 text-white">
                   your own case 
                </span> 
                 now
              </h2>
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              rounded-xl bg-gray-900/10 ring-inset ring-gray-900/10 lg:rounded-2xl">
                <img 
                  src="horse.jpg"
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            <li>
              <Check className="h-5 w-5 text-green-600 inline-flex mr-1.5"/>
            ...
            <div className="flex justify-center">
              ...
              >
                Create yourn case now <ArrowRight className="h-4 w-4 ml-1.5"/>
              </Link>
            </div>
          </ul>
        </MaxWidthWrapper>
